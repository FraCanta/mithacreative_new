  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-[90%] mx-auto lg:min-h-[calc(90vh_-_100px)] min-h-[calc(90vh_-_80px)] 2xl:min-h-[calc(100vh_-_100px)]">
      ...
      <motion.div
        ...
        initial="initial"
        animate="enter"
        className="relative flex flex-col items-center justify-center w-full my-4 lg:my-8 2xla:my-14"
      >
        <motion.h1
          variants={opacity}
          initial="initial"
          animate="enter"
          className="text-primary dark:text-white text-[65px] md:text-[150px] lg:text-[110px] 2xla:text-[138px] font-bold flex flex-col justify-between h-full relative leading-[1.3]"
        >
        ...
        <motion.div
          ...
          initial="initial"
          animate="enter"
          className="absolute z-10 flex items-center justify-center w-full h-full overflow-hidden -translate-y-1/2 lg:overflow-visible lg:-left-12 top-1/2"
        >
          <Image
            src={Astronauta}
            width={600}
